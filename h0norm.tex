...
\hline
\cellcolor[gray]{0.84}Versie & 3.4\\
\hline
...
\begin{figure}[!ht]
  \captionbox
  {Jeugdmodule, asymmetrisch (N.B.: de maat 100mm moet 110mm zijn)\label{im:jeugdbak}}
  {\includegraphics[scale=0.6]{images/jeugdbak}}
\end{figure}
...
De hartmaat van de rails is hierbij hetzelfde als de andere modules: 57mm. De rails wordt dicht tegen de voorkant va de bak aangelegd, waarbij de afstand tussen de voorkant van de module en het midden van de eerste rail 100mm bedraagt plus de dikte van de gebruikte plaat (9mm in de meeste gevallen), dus 109mm. Voor het gemak houden we 110mm aan.
...
\hline
Basismodule 3a&Links 2 sporen, rechts 4 sporen&\parbox{1em}{\includegraphics[width=7cm]{images/module_3a}} \\
\hline
Basismodule 3b&Links 4 sporen, rechts 2 sporen& \parbox[s]{1em}{\includegraphics[width=7cm]{images/module_3b}} \\
\hline
Basismodule 3c&Links 2 sporen, rechts 3 sporen (linkerspoor met wissel)&\parbox[s]{1em} {\includegraphics[width=7cm]{images/module_3c}} \\
\hline
Basismodule 3d&Links 2 sporen, rechts 3 sporen (rechterspoor met wissel)&\parbox[s]{1em} {\includegraphics[width=7cm]{images/module_3d}} \\
\hline
Basismodule 3e&Links 3 sporen, rechts 2 sporen (linkerspoor met wissel)&\parbox[s]{1em} {\includegraphics[width=7cm]{images/module_3e}} \\
\hline
Basismodule 3f&Links 3 sporen, rechts 2 sporen (rechterspoor met wissel)&\parbox[s]{1em} {\includegraphics[width=7cm]{images/module_3f}} \\
\hline
Basismodule 3g&Links 3 sporen, rechts 3 sporen (linkerspoor met wissel naar links, rechterspoor met wissel naar rechts)&\parbox[s]{1em} {\includegraphics[width=7cm]{images/module_3g}} \\
\hline
Basismodule 3h&Links 3 sporen, rechts 3 sporen ( rechterspoor met wissel naar links, linkerspoor met wissel naar rechts)&\parbox[s]{1em} {\includegraphics[width=7cm]{images/module_3h}} \\
\hline
\end{tabular}
}
...
We houden de volgende kleuren aan:
\begin{table}[!ht]
\begin{tabular}{| l | l | l |}
\hline
\cellcolor[gray]{0.84}Kleur&\cellcolor[gray]{0.84}Functie&\cellcolor[gray]{0.84}Aansluiting\\
\hline
Rood&Digitale spanning&vast aangesloten aan middengeleider\\
\hline
Bruin&Digitale nul&vast aangesloten aan buitenste rail\\
\hline
Paars&Schakelrails&aangesloten aan digitale spanning bij 2-rail, nul bij 3-rail\\
\hline
\end{tabular}
\caption{Kleuren Aansluitdraden}
\end{table}
...
Er zijn meerdere soorten modules bij deze baan: 
\begin{itemize}
\item basismodules met alleen 2 sporen, zonder wissels of seinen, deze worden gewoon doorgelust en kunnen tussen willekeurige andere modules worden geplaatst
\item 'seinenmodules', deze kunnen seinen en wissels bevatten
\item stationsmodules
\item keerlusmodules
\end{itemize}

\subsection{Basismodules}
Er zijn 2 soorten basismodules bij deze baan: modules met alleen 2 sporen, zonder wissels of seinen, deze worden gewoon doorgelust, en 'seinenmodules', deze zijn voorzien van een of meerdere van de volgende zaken:
...
Elke seinenmodule is voorzien van detectiestukken, deze worden middels banaanstekkers verbonden aan het bezetmelder aansluitblok.  In dit aansluitblok zit een blauwe kabel en een dubbele netwerkaansluitdoos. 

\subsection{Omschakelen basismodules}

Op dit moment zijn de modules waarop een booster is gemonteerd, voorzien van een schakelaar waarmee is om te schakelen tussen 2- en 3-rail, zie figuur \ref{im:moduleswitch}.

\begin{figure}[!ht]
  \captionbox
  {Omschakelaar module\label{im:moduleswitch}}
  {\includegraphics[scale=1.0]{images/schakelpaneel_module}}
\end{figure}
\begin{figure}[!ht]
  \captionbox
  {Omschakelaar centrale\label{im:centraleswitch}}
  {\includegraphics[scale=1.0]{images/schakelpaneel_centrale}}
\end{figure}

Naast de schakelaar zijn er 3 aansluitbussen gemonteerd:
\begin{itemize}
\item Rood: digitale rijspanning
\item Zwart: massa van rijspanning
\item Groen: Geschakelde rijspanning via schakelaar
\end{itemize}

Ook de stationsmodules kunnen omgeschakeld worden middels een schakelknop op het bedieningspaneel, zie figuur \ref{im:centraleswitch}.

Bij het omschakelen moet eerst de digitale spanning van de baan worden gehaald, dit kan door op de centrale of de multimaus het digitale signaal te stoppen (knop 'STOP' op de Multimaus, knop 'OFF' op de centrale), daarna moeten alles boosters worden omgeschakeld, en daarna mag de spanning er weer op.

\subsection{Omschakelen basismodules zonder schakelaars}

Voor de volledigheid volgt hieronder de methodiek voor het handmatig omschakelen van  rijden op 2- of 3-rails:
...
\subsection{Stationsmodules}

De stationsmodules vormen een complete 'inzet', bestaande uit 6 modules met een basisformaat van 120 x 60 cm, die in een vaste opstelling worden neergezet.

De aansluitingen met de rest van de baan lopen via de standaard connectoren zoals beschreven in de voorgaande paragrafen, er zijn dus 2 modules (SA1 en SA3) die voorzien zijn van deze connectoren. De hele inzet kan dan ook beschouwd worden als een enkele module voor wat betreft de aansluitingen.

\begin{figure}[!ht]
  \captionbox
  {Overzicht stationsmodules\label{im:stationsmodules}}
  {\includegraphics[scale=0.8]{images/overzicht_stationsmodules}\\}
\end{figure}

Zo mogelijk moet deze inzet gebruikt worden met de centrale/boosterkast (zie paragraaf \ref{ss:centrale}), waarbij deze inzet dus ook met boosterscheidingskabels wordt ge\"isoleerd van de overige modules.

De aansluitingen tussen de stationsmodules worden gevormd door kabels met 25-polige D-connectoren, evenals de aansluiting met de centrale/boosterkast.

\begin{figure}[!ht]
  \captionbox
  {Aansluitingen stationsmodules\label{im:stationsconnectors}}
  {\includegraphics[scale=1.0]{images/aansluitingen_stationsmodules}\\}
\end{figure}

Aan de voorkant van twee modules (SV1 en SV3) in figuur \ref{im:stationsmodules}) zitten extra aansluitingen voor de muizen, zie figuur \ref{im:multimaus_hub}.

\begin{figure}[!ht]
  \captionbox
  {Aansluiting (Multi)Maus\label{im:multimaus_hub}}
  {\includegraphics[scale=0.5]{images/multimaus_hub}\\}
\end{figure}
...
\begin{figure}[!ht]
  \captionbox
  {Bovenaanzicht modulebooster\label{im:modulebooster}}
...
\begin{figure}[!ht]
  ...
  {\includegraphics[scale=0.5]{images/rcu_boosterscheiding}}\\
\end{figure}
...
\subsection{Centrale Stationsmodule met booster}
\label{ss:centrale}

Voor de aansturing van de stationsmodules is een kast gebouwd (figuur \ref{im:centralekast})met daarin:

\begin{enumerate}
\item Hoofdschakelaar voor stroomvoorziening baan (rechts op figuur \ref{im:centralekast})
\item Universele centrale (zie hoofdstuk \ref{ch:centrale}, links op figuur \ref{im:centralekast})
\item Modulebooster voor stroomvoorziening stationsmodules
\item Schakelkast voor stationsmodules
\item Aansluitblok voor overige boosters (grijze aansluitkastje rechtsboven op figuur \ref{im:centralekast})
\end{enumerate}

\begin{figure}[!ht]
  \captionbox
  {Schakelkast Stationsmodules\label{im:centralekast}}
  {\includegraphics[scale=1.0]{images/schakelkast_station}\\}
\end{figure}

Hierbij is het van belang dat de overige moduleboosters worden aangesloten via het aansluitblok 4, en de multimaus via de voorste aansluitingen van de boosters.

Op een 230 volt-stekkerblok onderin de kast worden alle voedingen voor de boosters en de verlichting aangesloten, zodat de hele baan geschakeld kan worden met de hoofdschakelaar.
...
\section{Rijden met de (Multi)Maus}
\label{ss:multimaus}

Voor het bedienen van de treinen, wissels en seinen wordt gebruik gemaakt van Roco controllers, de zogenaamde 'muis'. Er zijn meerdere types, wij gebruiken er twee:
\begin{itemize}
\item Roco Maus, in grijze of rode uitvoering, zie figuur \ref{im:roco_maus}
\item Roco Multimaus, zie figuur \ref{im:roco_multimaus}
\end{itemize}

\begin{figure}[!ht]
  \centering
  \begin{subfigure}{.5\textwidth}
    \includegraphics[scale=0.25]{images/roco_maus}
    \caption{Roco (Power)Mouse/Maus\label{im:roco_maus}}
  \end{subfigure}%
  \begin{subfigure}{.5\textwidth}
    \includegraphics[scale=0.4]{images/roco_multimaus}
    \caption{Roco Multimaus\label{im:roco_multimaus}}
   \end{subfigure}
   \caption{Roco Muizen}
\end{figure}

De muizen worden aangesloten aan de voorkant van de booster of aan de aansluitkastjes bij de stationsmodule met een 6-aderige kabel. Let op: ze mogen niet direct aan de centrale worden gekoppeld.
De muizen zijn qua bediening vergelijkbaar, de voornaamste verschillen zijn:

\begin{table}[H]
\begin{tabular}{|l|l|l|}
\hline
Functie&Roco Maus&Roco Multimaus\\
\hline
Aantal locs&99&9999\\
\hline
Adressen&1-99&1-9999\\
\hline
Namen voor locs&Nee&Ja\\
\hline
Invoer locadressen&Pijltjes&Numeriek toetsenbord\\
\hline
Functies&4&28\\
\hline
Wissels en Seinen sturen&Nee&Ja\\
\hline
Stopindicatie&Knippert&'Stop' symbool in scherm\\
\hline
\end{tabular}
\caption{Verschillen Roco Muizen}
\end{table}

De stop knop op beide typen muizen heeft als functie het stoppen of starten van het digitale signaal, dit houdt dus in dat een stopsignaal op een willekeurige muis of de centrale het stoppen van alle treinen tot gevolg heeft. Dit staat los van de kortsluitmelding van een booster, deze heeft geen terugmelding aan de centrale of de andere muizen.
