...
\hline
\cellcolor[gray]{0.84}Versie & 3.2\\
\hline
...
De aansluitingen met de rest van de baan lopen via de standaard connectoren zoals beschreven in de voorgaande paragrafen, er zijn dus 2 modules (SA1 en SA3) die voorzien zijn van deze connectoren. De hele inzet kan dan ook beschouwd worden als een enkele module voor wat betreft de aanslutiingen.
