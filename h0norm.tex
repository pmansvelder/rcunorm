...
Bij elke module hoort een achterwand, deze is vast bevestigd aan de module. De hoogte van de achterwand is 48 cm (gemeten vanaf bovenkant rails). De achterwand wordt standaard blauw geschilderd.

\section{Verlichting}
\label{se:verlichting}
Boven elke module komt verlichting in de vorm van een LEDstrip.
